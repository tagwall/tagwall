...
// automated milestones once Genesis fills. Chains in the marketing
// rotation get a dedicated per-chain tweet.
...
Open now on PulseChain, HyperEVM, and Robinhood Chain.
...
tagwall.io/founders`,
  ...
  },
  {
    ...
    text: `The wall just opened on Robinhood Chain, day zero.

All 100 Genesis slots are unclaimed. A few cents of ETH and one pixel locks your number into the chain permanently, before almost anything else exists there.

Genesis #1 on a brand-new chain is a once-per-chain event.
...
tagwall.io/founders`,
    graphic: {
      ...
      eyebrow: 'Genesis on Robinhood Chain',
      hero: '100',
      heroSub: 'slots, none claimed yet',
      subline: 'Day zero. Be earlier than early.',
    },
  },
  {
    id: 'flex',
    label: 'Painter flex template',
    text: `I just claimed Genesis #[N] on [PulseChain / HyperEVM / Robinhood Chain].
